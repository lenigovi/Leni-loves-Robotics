import { CurrentRoute } from '#/app/dynamic-programming/_ui/current-route';
    ...
    <Boundary labels={['@children/default.tsx']} color="blue" size="small">
      <div className="prose prose-sm prose-invert max-w-none">
        ...
        <ul className="text-xs">
          ...
          <li>
            <code>dynamic-programming/default.js</code> OR{' '}
            <code>dynamic-programming/@children/default.js</code> exists.
          </li>
        </ul>
